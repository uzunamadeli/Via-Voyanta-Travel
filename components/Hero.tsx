             ...
             `}>
                ...
                {(!isExpanded && isSticky) ? (
                    ...
                    >
                        ...
                        <span className="font-semibold whitespace-nowrap">{t.hero.searchBtn}</span>
                    </button>
                ) : (
                    ...
                    <div className="flex flex-col md:flex-row gap-2 animate-fade-in">
                        ...
                        <div className="flex-1 px-6 py-3 border-b md:border-b-0 md:border-r border-blue-800 dark:border-slate-700">
                            <label className="block text-xs font-bold text-sky-300 dark:text-slate-400 uppercase tracking-wider mb-1 text-left">{t.hero.searchWhere}</label>
                            <input 
                                type="text" 
                                placeholder={t.hero.phWhere} 
                                className="w-full outline-none text-white placeholder-blue-200/50 dark:placeholder-slate-500 bg-transparent text-left" 
                            />
                        </div>
                        
                        <div className="flex-1 px-6 py-3 border-b md:border-b-0 md:border-r border-blue-800 dark:border-slate-700">
                            <label className="block text-xs font-bold text-sky-300 dark:text-slate-400 uppercase tracking-wider mb-1 text-left">{t.hero.searchDate}</label>
                            <input 
                                type="text" 
                                placeholder={t.hero.phDate} 
                                className="w-full outline-none text-white placeholder-blue-200/50 dark:placeholder-slate-500 bg-transparent text-left" 
                            />
                        </div>
                        
                        <div className="flex-1 px-6 py-3">
                            <label className="block text-xs font-bold text-sky-300 dark:text-slate-400 uppercase tracking-wider mb-1 text-left">{t.hero.searchPerson}</label>
                            <input 
                                type="number" 
                                placeholder={t.hero.phPerson} 
                                className="w-full outline-none text-white placeholder-blue-200/50 dark:placeholder-slate-500 bg-transparent text-left" 
                            />
                        </div>
