...
interface ViaChatbotProps {
  language: Language;
}

const ViaChatbot: React.FC<ViaChatbotProps> = ({ language }) => {
  ...
  const handleSend = async (e?: React.FormEvent) => {
    ...
    try {
      ...
      const responseText = await generateViaResponse(userText, historyForApi, language);
        ...
        <div className="bg-gradient-to-r from-blue-950 to-blue-800 p-4 rounded-t-2xl flex items-center gap-3">
            ...
            <div>
                ...
                <div className="flex items-center gap-1.5">
                    ...
                    <span className="text-sky-100 text-xs">{t.chat.online}</span>
                </div>
            </div>
        </div>
