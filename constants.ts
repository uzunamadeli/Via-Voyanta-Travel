...
export const TOURS_DATA: ServiceItem[] = [
  {
    ...
    price: 55,
    rating: 4.9,
    image: 'https://images.unsplash.com/photo-1673005540028-e40e83ee8b3e?w=800&h=600&fit=crop&q=80',
  ...
  },
  {
    ...
    price: 15,
    rating: 4.9,
    image: 'https://images.unsplash.com/photo-1612483197406-721b7e09e033?w=800&h=600&fit=crop&q=80',
    type: ServiceType.TOUR,
    location: 'Kapadokya',
  ...
  },
  {
    ...
    price: 28,
    rating: 4.9,
    image: 'https://images.unsplash.com/photo-1642427749670-f20e2e76ed8c?w=800&h=600&fit=crop&q=80',
    type: ServiceType.TOUR,
    location: 'Kapadokya',
  ...
  },
  {
    ...
    price: 40,
    rating: 5.0,
    image: 'https://images.unsplash.com/photo-1551524559-8af4e6624178?w=800&h=600&fit=crop&q=80',
    type: ServiceType.TOUR,
    location: 'Kapadokya',
    duration: { tr: '7 - 8 Saat', en: '7 - 8 Hours' },
  ...
  },
  {
    ...
    price: 13,
    rating: 4.9,
    image: 'https://images.unsplash.com/photo-1568772585407-9361f9bf3a87?w=800&h=600&fit=crop&q=80',
    type: ServiceType.TOUR,
    location: 'Kapadokya',
    duration: { tr: '2 Saat', en: '2 Hours' },
  ...
  },
  {
    ...
    price: 12,
    rating: 4.8,
    image: 'https://images.unsplash.com/photo-1609861219261-7b411da11bfc?w=800&h=600&fit=crop&q=80',
    type: ServiceType.TOUR,
    location: 'Kapadokya',
    duration: { tr: '1 - 2 Saat', en: '1 - 2 Hours' },
  ...
  },
  {
    ...
    price: 42,
    rating: 4.8,
    image: 'https://images.unsplash.com/photo-1549880338-65ddcdfd017b?w=800&h=600&fit=crop&q=80',
    type: ServiceType.TOUR,
    location: 'Kapadokya',
  ...
  },
  {
    ...
    price: 40,
    rating: 4.9,
    image: 'https://images.unsplash.com/photo-1586016413664-864c0dd76f53?w=800&h=600&fit=crop&q=80',
    type: ServiceType.TOUR,
    location: 'Kapadokya',
    duration: { tr: '7 - 8 Saat', en: '7 - 8 Hours' },
  ...
  },
  {
    ...
    price: 25,
    rating: 4.9,
    image: 'https://images.unsplash.com/photo-1577083288073-40892c0860a4?w=800&h=600&fit=crop&q=80',
    type: ServiceType.TOUR,
    location: 'Kapadokya',
    duration: { tr: '1 Saat', en: '1 Hour' },
  ...
  },
  {
    ...
    price: 45,
    rating: 5.0,
    image: 'https://images.unsplash.com/photo-1641128324972-af3212f0f6bd?w=800&h=600&fit=crop&q=80',
    type: ServiceType.TOUR,
    location: 'Kapadokya',
    duration: { tr: '7 - 8 Saat', en: '7 - 8 Hours' },
  ...
  },
  {
    ...
    price: 28,
    rating: 4.9,
    image: 'https://images.unsplash.com/photo-1540555700478-4be289fbec6d?w=800&h=600&fit=crop&q=80',
    type: ServiceType.TOUR,
    location: 'Kapadokya',
    duration: { tr: '1 Saat', en: '1 Hour' },
  ...
  },
  {
    ...
    price: 38,
    rating: 4.8,
    image: 'https://images.unsplash.com/photo-1565689157206-0fddef7589a2?w=800&h=600&fit=crop&q=80',
    type: ServiceType.TOUR,
    location: 'Kapadokya',
    duration: { tr: '2 Saat', en: '2 Hours' },
  ...
  },
  {
    ...
    price: 50,
    rating: 4.8,
    image: 'https://images.unsplash.com/photo-1529973565457-a60a2ccf750d?w=800&h=600&fit=crop&q=80',
    type: ServiceType.TOUR,
    location: 'Kapadokya',
    duration: { tr: '2 Saat', en: '2 Hours' },
  ...
  },
  {
    ...
    price: 100,
    rating: 5.0,
    image: 'https://images.unsplash.com/photo-1583267746897-2cf415887172?w=800&h=600&fit=crop&q=80',
    type: ServiceType.TOUR,
    location: 'Kapadokya',
    duration: { tr: '2 Saat', en: '2 Hours' },
